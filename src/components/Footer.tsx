...
function Footer() {
  return (
    <div className="flex w-full h-screen bg-zinc-900 py-20 px-20 overflow-hidden">
      <div className="w-1/2 flex h-full flex-col justify-between  font-foundersGrotesk">
        <div className="heading">
          <h1 className="text-[8vw] uppercase leading-none -mb-2">Eye</h1>
          <h1 className="text-[8vw] uppercase leading-none -mb-2">Opening</h1>
        </div>
        <svg
          width="72"
          height="30"
      ...
      <div className="w-1/2">
        <h1 className="font-foundersGrotesk text-[8vw] uppercase leading-none  -mb-2">Presentations</h1>
        <div className='mt-10 flex flex-col dets'>
